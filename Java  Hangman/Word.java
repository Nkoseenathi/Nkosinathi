...
public class Word implements Comparable<Word> {
   ...
   public Word toUpperCase() { 
      return new Word(wordPhrase.toUpperCase()); }
   public Word toLowerCase() { 
      return new Word(wordPhrase.toLowerCase()); }
 ...
 /**
   ...
   public int indexOf(char c, int fromIndex) { 
      return wordPhrase.indexOf(c, fromIndex); }
   ...
   public int lastIndexOf(char c, int fromIndex) { 
      return wordPhrase.lastIndexOf(c, fromIndex); }
