...
public class Pattern {
   ...
   public Pattern toUpperCase() { 
      return new Pattern(pattern.toUpperCase()); }
   ...
   private static String restOf(String string) { 
   ...
   public int indexOf(char c, int fromIndex) { 
      return pattern.indexOf(c, fromIndex); }
   ...
   public int lastIndexOf(char c, int fromIndex) { 
      return pattern.lastIndexOf(c, fromIndex); }
